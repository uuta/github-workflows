...
The primary model is `openrouter/nvidia/nemotron-3-ultra-550b-a55b:free`. If that request fails, PR-Agent can fall back to `openrouter/stepfun/step-3.7-flash`. PR-Agent allows up to 64,000 model tokens and uses a 1,000,000-token custom-model context limit for fitting pull request content.
